...
parser.add_argument('--vcf', default='/data/humangen_kircherlab/Projects/Model_MPRA_Benchmark/01_Data/IGVFFI4134MFLL.vcf.gz', help='Input VCF (gzipped)')
...
parser.add_argument('--out', default='variant_SAD_raw_MFLL.csv', help='Output CSV')
...
_log(f'Columns: meta({len(meta_cols)}) + aggs({len(agg_cols)}) + tracks({len(track_cols)}).')
